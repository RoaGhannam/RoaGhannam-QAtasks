...
describe('', () => {
    it('validate that the user will be redirected to the correct page when click on conduit', () => {
    ...
    describe('', () => {
        it('Validate that the user can sign up to the system', () => {
            cy.visit("https://demo.productionready.io/#/register")
    ...
    describe('', () => {
        it('validate that the user will be redirected to the correct page when click on Have an account?', () => {
            cy.visit("https://demo.productionready.io/#/register")
